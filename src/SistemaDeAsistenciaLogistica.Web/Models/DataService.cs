...
namespace SistemaDeAsistenciaLogistica.Web.Models
{
    public static class DataService
    {
		...
		{
			double y = 50;
			DateTime dateTime = new DateTime(2020, 01, 1, 0, 0, 0);
			string label = "";
		...
		public static List<DataPoint> GetRandomDataForDateTimeAxis(int count)
		{
			...
			var dateTime = new DateTime(2020, 01, 10, 0, 0, 0, DateTimeKind.Local);
