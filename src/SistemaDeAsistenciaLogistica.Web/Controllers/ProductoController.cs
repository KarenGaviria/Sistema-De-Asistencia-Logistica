...
namespace SistemaDeAsistenciaLogistica.Web.Controllers
{
    public class ProductoController : Controller
    {
        ...
        {
            var sistemaDeAsistenciaLogisticaDbContext = _context.Producto.Include(p => p.IdMaterialNavigation).Include(p => p.IdTipoProductoNavigation);
        ...
        {
            ViewData["IdMaterial"] = new SelectList(_context.Material, "IdMaterial", "NombreMaterial");
            ViewData["IdTipoProducto"] = new SelectList(_context.TipoProducto, "IdTipoProducto", "NombreProducto");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,Nombre,IdMaterial,IdTipoProducto,PrecioUnidad")] Producto producto)
        {
