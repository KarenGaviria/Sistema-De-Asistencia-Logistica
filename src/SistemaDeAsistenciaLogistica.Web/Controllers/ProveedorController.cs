...
namespace SistemaDeAsistenciaLogistica.Web.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        public ProveedorController(SistemaDeAsistenciaLogisticaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Distribuidora,Direccion,Telefono")] Proveedor proveedor)
        {
